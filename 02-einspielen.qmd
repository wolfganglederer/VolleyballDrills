...
Person **A** wirft/schlägt den Ball ins Netz. Die Person **B** sichert, spielt sich selbst zu und greift ins Netz an. Nun sichert **A**, spielt sich den Ball selbst zu und greift wieder in Netz an. usw...
...
3 Spieler wechseln sich auf der Netzposition ab und greifen diagonal an.
...
Der Ball wird abwechselnd mt links und rechts gegen die Wand geworfen und mit der jeweils anderen Hand gefangen. Darauf achten, dass der Ball mit den Fingern gefangen wird und nicht mit dem Ballen. Die Schwierigkeit kann durch den Abstand zur Wand und das Tempo mit dem geworfen wir variiert werden.

### Ball gegen die Wand II

Zwei Spieler. Spieler eins steht in Abwehrhaltung mit Blick auf die Wand. Spieler zwei wirft den Ball von hinten gegen die Wand und Spieler 1 fängt. Mit beiden Händen und danach mit einer Hand. Schwierigkeit mit Abstand zur Wand und Geschwindigkeit variieren.
